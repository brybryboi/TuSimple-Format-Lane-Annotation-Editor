...
class LaneLabelTool(QMainWindow):
    ...
    def init_ui(self):
        ...
        change_lane_up_shortcut1 = QShortcut(QKeySequence("Ctrl+Up"), self)
        change_lane_up_shortcut1.activated.connect(self.change_lane_up)
        change_lane_up_shortcut2 = QShortcut(QKeySequence("Ctrl+C"), self)
        change_lane_up_shortcut2.activated.connect(self.change_lane_up)
        change_lane_down_shortcut1 = QShortcut(QKeySequence("Ctrl+Down"), self)
        change_lane_down_shortcut1.activated.connect(self.change_lane_down)
        change_lane_down_shortcut2 = QShortcut(QKeySequence("Ctrl+X"), self)
        change_lane_down_shortcut2.activated.connect(self.change_lane_down)
    ...
    def goto_image_by_index(self):
        ...
        if not hasattr(self, "annotation_data") or idx < 1 or idx >= len(self.annotation_data) + 1:
            QMessageBox.warning(self, self.lang_manager.get_text("dialog_warning"), 
